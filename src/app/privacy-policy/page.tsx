			...
			<div className="pt-10 mx-4 lg:mx-14 xl:mx-40 sm:p-10 sm:text-left flex flex-col gap-3 md:gap-6 text-sm text-white">
						...
						<div className="text-muted-foreground">
							...
							<div className="pl-4 list">
								...
								<li>
									...
									this Agreement) refers to EDU Infonence,
									Flat B 501, Essen Marvella, Hyderabad 67.
								</li>
								<li>
								...
								<li>
									<strong>Website</strong> refers to Schools
									in Hyderabadd, accessible from
									https://www.schoolsinhyderabad.co.in
								</li>
								<li>
				...
				<div>
					...
					<div className="flex flex-col gap-2">
						...
						<div className="pl-4 list text-muted-foreground">
							<li>Email address</li>
							...
							<div className="text-muted-foreground">
								...
								<div>
									...
									<span>
										...
										about cookies on TermsFeed website
										article.
									</span>
									...
									<div className="pl-4 list text-muted-foreground">
										...
										<li>
											<strong>
												...
												Acceptance Cookies Type:
											</strong>{" "}
											Persistent Cookies Administered by:
											Us Purpose: These Cookies identify
											if users have accepted the use of
										...
										<li>
											...
											Persistent Cookies Administered by:
											Us Purpose: These Cookies allow us
											to remember choices You make when
											You use the Website, such as
											remembering your login details or
											language preference. The purpose of
											these Cookies is to provide You with
					...
					<div className="grid gap-3 pt-2">
						...
						<div>
							...
							<div className="text-muted-foreground">
								...
								<p>By email: info@schoolsinhyderabad.co.in</p>
							</div>
						</div>
					</div>
				</div>
