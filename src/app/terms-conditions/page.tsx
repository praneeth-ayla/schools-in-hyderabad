			...
			<div className="pt-10 mx-4 lg:mx-14 xl:mx-40 sm:p-10 sm:text-left flex flex-col gap-3 md:gap-6 text-sm ">
				<div>
					...
					<div className="grid gap-2 text-muted-foreground">
						<p>Welcome to Schools in Hyderabad!</p>
						<p>
							These terms and conditions outline the rules and
							regulations for the use of EDU Infonence’s Website,
							located at https://www.schoolsinhyderabad.co.in.
						</p>
						<p>
							By accessing this website we assume you accept these
							terms and conditions. Do not continue to use Schools
							in Hyderabad if you do not agree to take all of the
						...
						<p>
							...
							subject to, prevailing law of in. Any use of the
							above terminology or other words in the singular,
							plural, capitalization and/or he/she or they, are
							taken as interchangeable and therefore as referring
							to same.
						</p>
					</div>
				</div>
				<div className="grid gap-2 text-muted-foreground">
					...
					<p>
						We employ the use of cookies. By accessing Schools in
						Hyderabad, you agreed to use cookies in agreement with
						the EDU Infonence’s Privacy Policy.
					</p>
					<p>
					...
					<p>
						Unless otherwise stated, EDU Infonence and/or its
						licensors own the intellectual property rights for all
						material on Schools in Hyderabad. All intellectual
						property rights are reserved. You may access this from
						Schools in Hyderabad for your own personal use subjected
						to restrictions set in these terms and conditions.
					</p>
					<p>You must not:</p>
					<div className="pl-4">
						<li>Republish material from Schools in Hyderabad</li>
						<li>
							Sell, rent or sub-license material from Schools in
							Hyderabad
						</li>
						<li>
							Reproduce, duplicate or copy material from Schools
							in Hyderabad
						</li>
						<li>Redistribute content from Schools in Hyderabad</li>
					</div>
					<p>This Agreement shall begin on the date hereof.</p>
					<p>
						Parts of this website offer an opportunity for users to
						post and exchange opinions and information in certain
						areas of the website. EDU Infonence does not filter,
						edit, publish or review Comments prior to their presence
						on the website. Comments do not reflect the views and
						opinions of EDU Infonence, its agents and/or affiliates.
						Comments reflect the views and opinions of the person
						who post their views and opinions. To the extent
						permitted by applicable laws, EDU Infonence shall not be
					...
					<p>
						EDU Infonence reserves the right to monitor all Comments
					...
					<p>
						You hereby grant EDU Infonence a non-exclusive license
					...
					<p>
						...
						EDU Infonence; and (d) the link is in the context of
					...
					<p>
						...
						you must inform us by sending an e-mail to EDU
						Infonence. Please include your name, your organization
					...
					<p>
						No use of EDU Infonence’s logo or other artwork will be
