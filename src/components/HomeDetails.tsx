				...
				<div className="grid md:grid-cols-2 gap-8 sm:gap-10 bg-gradient-to-r  ">
					<div>
						...
						<p className="text-base md:text-lg text-muted-foreground">
							Hyderabad, the “City of Pearls,” blends modernity
							with its rich cultural heritage. With landmarks like
							Birla Mandir and Golconda Fort, the city&apos;s
							historical depth inspires students to embrace their
							cultural roots while looking towards the future.
							This unique environment makes Hyderabad an ideal
							place to raise and educate children.
						</p>
					</div>
					<div>
						<h1 className="text-lg sm:text-2xl font-bold pb-3 sm:pb-5">
						...
						<p className="text-base md:text-lg text-muted-foreground">
							...
							schools from state and central boards to
							international institutions. Schools here provide
							cutting-edge facilities, expert educators, and a
							curriculum that balances academics with
