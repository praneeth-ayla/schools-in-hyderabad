		...
		<div className="text-white p-4">
			<div className="sm:px-5 md:px-10 lg:px-20 xl:px-36 pt-4 lg:pt-8">
				...
				<div className="flex flex-col-reverse lg:flex-row gap-3 pb-10">
					<Card className="mt-10 lg:mt-0 row-start-2 shadow-lg px-4 pb-10 bg-black bg-opacity-50 text-white border border-blue-900">
					...
					<Card className="lg:col-start-4 py-10 lg:col-span-full shadow-lg bg-black bg-opacity-50 text-white border border-blue-900">
