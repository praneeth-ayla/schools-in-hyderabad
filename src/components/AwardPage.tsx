...
import { useGetAward } from "../lib/hooks";
...
export default function AwardPage({ award }: { award: string }) {
	const id = getIdFromSlug(award);
	const { event, failed, isLoading } = useGetAward(id);
